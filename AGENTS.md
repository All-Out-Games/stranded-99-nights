...
- Use `Notifier.notify(player, "message")` to send feedback on interactions (e.g. "you don't have enough money")
- Note: client logs will have duplicate entries. Prefer server logs for gameplay debugging.
